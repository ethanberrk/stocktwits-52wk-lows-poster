...
includes today, verified 2026-09-03). The lows-side `$5M` dollar-volume floor
is applied from `Last * Volume` on the same quote.
...
any owner-locked rule. Ported from the highs poster (same design); RS / RW follow.
